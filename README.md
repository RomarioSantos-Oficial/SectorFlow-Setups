...
[![Discord](https://img.shields.io/badge/Discord-Join%20Us-5865F2?style=for-the-badge&logo=discord)]([(https://discord.gg/6sqNmZkJKR)](https://discord.com/invite/6sqNmZkJKR))
...
### 📥 Download e Instalação Rápida (Recomendado)

> Não precisa instalar Python. Baixe e execute diretamente!

#### Passo 1 — Baixar o executável

**👉 [Clique aqui para baixar o SectorFlow Setups v1.0-beta](https://github.com/RomarioSantos-Oficial/SectorFlow-Setups/releases/tag/v1.0-beta)**

1. Acesse o link acima
2. Role até a seção **Assets**
3. Clique em `SectorFlowSetups.exe` para baixar

#### Passo 2 — Requisitos antes de executar

| Requisito | Detalhe |
|---|---|
| 🖥️ Sistema Operacional | Windows 10 ou 11 (64-bit) |
| 🎮 Jogo | **Le Mans Ultimate instalado e rodando** |
| 📁 Arquivo base | Um arquivo `.svm` de setup do LMU |

> ⚠️ **IMPORTANTE:** Esta ferramenta funciona **exclusivamente com Le Mans Ultimate**. Não é compatível com outros simuladores.
...
3. Vá para a aba "Setup"
4. Clique em "Carregar .svm" e escolha seu setup base
5. Entre na pista e complete pelo menos 1 volta
6. Volte ao app → clique em "Sugestões IA" ou "Heurísticas"
7. Aplique as sugestões e teste na pista!
```

#### Regras de Uso

- ✅ Apenas para **Le Mans Ultimate**
- ✅ Jogo deve estar **aberto e rodando** para conectar
- ✅ Precisa de um arquivo `.svm` como base de setup
- ❌ Não funciona com rFactor 2, ACC ou outros sims
- ❌ Não funciona sem o jogo instalado (modo telemetria limitado)

#### Solução de Problemas Rápida

<details>
<summary>🔴 O app abre mas não conecta ao jogo</summary>

1. Confirme que o **Le Mans Ultimate está aberto**
2. Verifique se a **Shared Memory** está ativada nas configurações do LMU
3. Tente reiniciar o aplicativo com o jogo já aberto
4. Veja os logs em `%APPDATA%\SectorFlowSetups\logs\`

</details>

<details>
<summary>🔴 O app não sugere nada</summary>

1. Complete **pelo menos 1 volta completa** na pista
2. Confirme que carregou um arquivo `.svm` de base
3. Verifique se a aba **Telemetria** exibe dados ao vivo (números mudando)

</details>

<details>
<summary>🔴 A IA parece fraca no início</summary>

Isso é **normal e esperado**. No início, o sistema depende mais de heurísticas e vai melhorando conforme você completa voltas e envia feedback. Com mais dados, as sugestões ficam mais precisas.

</details>

<details>
<summary>🔴 Windows bloqueou o .exe</summary>

1. Clique com o botão direito no `SectorFlowSetups.exe`
...
### 📥 Download & Quick Install (Recommended)

> No Python installation required. Download and run directly!

#### Step 1 — Download the executable

**👉 [Click here to download SectorFlow Setups v1.0-beta](https://github.com/RomarioSantos-Oficial/SectorFlow-Setups/releases/tag/v1.0-beta)**

1. Open the link above
2. Scroll to the **Assets** section
3. Click `SectorFlowSetups.exe` to download

#### Step 2 — Requirements before running

| Requirement | Details |
|---|---|
| 🖥️ Operating System | Windows 10 or 11 (64-bit) |
| 🎮 Game | **Le Mans Ultimate installed and running** |
| 📁 Base file | An `.svm` setup file from LMU |

> ⚠️ **IMPORTANT:** This tool works **exclusively with Le Mans Ultimate**. It is not compatible with other simulators.
...
6. Return to the app → click "AI Suggestions" or "Heuristics"
7. Apply the suggestions and test on track!
```

#### Usage Rules

- ✅ Only for **Le Mans Ultimate**
- ✅ Game must be **open and running** to connect
- ✅ Requires an `.svm` file as setup base
- ❌ Does not work with rFactor 2, ACC or other sims
- ❌ Does not work without the game installed (limited telemetry mode)

#### Quick Troubleshooting

<details>
<summary>🔴 The app opens but won't connect to the game</summary>
...
<details>
<summary>🔴 The app doesn't suggest anything</summary>
...
<details>
<summary>🔴 The AI seems weak at the start</summary>
...
<details>
<summary>🔴 Windows blocked the .exe</summary>
...
## 🛠️ For Developers — Run from Source (EN/PT)
...
# Run with auto-setup / Execute com configuração automática
.\start.ps1
# or / ou
start.bat
```
...
O script instala todas as dependências automaticamente e inicia o app.

### Manual install / Instalação manual
...
Este projeto está em **beta**. Funcionalidades podem mudar, bugs podem existir, e melhorias são contínuas.

## 📜 Changelog

### v2.0.0 — 2026-04-14
- **Melhorias na IA e Lógica de Setup:**
  - Heurísticas avançadas específicas para Le Mans Ultimate (LMU).
  - Gerenciamento de Virtual Energy (NRG) e alvos de pressão de pneus Michelin/Goodyear por classe.
  - Lógica de recompensa aprimorada para o sistema de aprendizagem.
  - Diferenciação de setups por condição climática (seco/chuva), tipo de sessão (qualificação/corrida), marca e modelo do carro.
- **Otimização de Performance:**
  - Refatoração do Frontend com cache de widgets para eliminar travamentos da GUI e otimizar a renderização da interface.
- **Persistência de Dados:**
  - Correção da falha no salvamento de dados de combustível no arquivo `.svm`.
  - Melhorias na integração entre a GUI e o core do sistema.
- **Amostragem de Dados:**
  - Implementação de sugestões para uma amostragem mais inteligente baseada em eventos críticos.

### v1.0-beta — 2026-04-07
...
| Language | Link |
|---|---|
| 🇧🇷 Português | [COMO_FUNCIONA_APLICACAO.md](docs/guides/COMO_FUNCIONA_APLICACAO.md) |
| 🇺🇸 English | [HOW_TO_USE_APPLICATION.md](docs/guides/HOW_TO_USE_APPLICATION.md) |
| 🇪🇸 Español | [COMO_USAR_LA_APLICACION.md](docs/guides/COMO_USAR_LA_APLICACION.md) |
| 🇯🇵 日本語 | [APPLICATON_USER_GUIDE_JA.md](docs/guides/APPLICATON_USER_GUIDE_JA.md) |
| 🇨🇳 中文 | [APPLICATION_USER_GUIDE_ZH.md](docs/guides/APPLICATION_USER_GUIDE_ZH.md) |

---

<div align="center">

**⚡ SectorFlow Setups — Built for Le Mans Ultimate / Feito para Le Mans Ultimate ⚡**

</div>

<!--  BELOW: Legacy full README content preserved for reference -->
<!--  ABAIXO: Conteúdo legado do README preservado para referência -->

---
<!-- LEGACY ENGLISH SECTION -->
